...
@Description(name = "jd_set5", value = "set(Any context, String redisUri, String key, String value, String nxxx, String expx, long time) -> String")
public class UDTFJedisSet5 extends JedisUDTF {
    ...
    protected UDFHelper.PrimitiveMethodBridge initMethodBridge(ObjectInspector[] argOIs) throws UDFArgumentException {
        Method setMd = null;
        try {
            setMd = Jedis.class.getDeclaredMethod("set", String.class, String.class, String.class, String.class, long.class);
