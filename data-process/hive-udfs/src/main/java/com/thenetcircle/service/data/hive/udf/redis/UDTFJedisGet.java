...
@Description(name = "jd_get", value = "get(String arg0) -> String")
public class UDTFJedisGet extends JedisUDTF {
    ...
    protected UDFHelper.PrimitiveMethodBridge initMethodBridge(ObjectInspector[] argOIs) throws UDFArgumentException {
        Method getMd = null;
        getMd = JedisHelper.getMethod("get", String.class);
        UDFHelper.PrimitiveMethodBridge mb = UDFHelper.getMethodBridge(JedisCommands.class, getMd, argOIs);
